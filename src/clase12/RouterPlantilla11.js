...
function crearRouterPlantilla11(){
    let productos2 = [
        {
            title: "Seiya de Pegaso",
            price: 888,
    ...
    //             errorNoInventario: "No hay productos en el inventario"
    //         });
    //     }
    //     res.render("index", {
    //         USERS_DB, bienvenida: "¡Bienvenidos al proyecto!"
    //     });
    // })
    ...
    //GET DATA
    routerApiProductos.get("/datos",(req,res)=>{
